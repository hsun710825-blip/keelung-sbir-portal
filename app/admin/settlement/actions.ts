...
export async function saveSettlementRowAction(
  ...
  await prisma.application.update({
    ...
    data: {
      settlementAppliedSubsidy: parseOptionalInt("appliedSubsidy"),
      settlementAppliedSelfFund: parseOptionalInt("appliedSelfFund"),
      settlementAppliedTotal: parseOptionalInt("appliedTotal"),
      ...
      settlementSubsidyTierRate: parseOptionalFloat("tierRate"),
    },
  });
